...
export const ClipboardCopyToggle = (_a) => {
    ...
    return (_jsx(Button, Object.assign({ type: "button", variant: "control", onClick: onClick, id: id, "aria-labelledby": `${id} ${textId}`, "aria-controls": isExpanded ? contentId : undefined, "aria-expanded": isExpanded }, props, { icon: _jsx("div", { className: css(styles.clipboardCopyToggleIcon), children: _jsx(AngleRightIcon, {}) }) })));
};
