...
if missing_in_azure:
    print(
        f"::warning file={AZURE_GATING},title=Missing gating tests::"
        "Missing gating tests in GitHub Actions, compared to PR-CI",
        missing_in_azure,
    )
...
if extra_in_azure:
    print(
        f"::warning file={AZURE_GATING},title=Extra gating tests::"
        "Extra gating tests in GitHub Actions, compared to PR-CI",
        extra_in_azure,
    )
