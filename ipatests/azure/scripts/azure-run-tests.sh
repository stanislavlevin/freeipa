...
IPA_TESTS_SERVER_MEM_RESERVATION="${!IPA_TESTS_SERVER_MEM_RESERVATION_VARNAME:-1600m}"

IPA_TESTS_REPLICA_MEM_RESERVATION_VARNAME="IPA_TESTS_REPLICA_MEM_RESERVATION_${PROJECT_ID}"
IPA_TESTS_REPLICA_MEM_RESERVATION="${!IPA_TESTS_REPLICA_MEM_RESERVATION_VARNAME:-1600m}"

IPA_TESTS_CLIENT_MEM_RESERVATION_VARNAME="IPA_TESTS_CLIENT_MEM_RESERVATION_${PROJECT_ID}"
IPA_TESTS_CLIENT_MEM_RESERVATION="${!IPA_TESTS_CLIENT_MEM_RESERVATION_VARNAME:-410m}"
