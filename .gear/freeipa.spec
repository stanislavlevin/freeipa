...
%changelog
* Mon Oct 06 2025 Stanislav Levin <slev@altlinux.org> 4.9.14-alt5.p10.1
- Backported upstream fixes (fixes: CVE-2025-7493).

* Wed Jun 18 2025 Stanislav Levin <slev@altlinux.org> 4.9.14-alt4.p10.1
- Backported upstream fixes (fixes: CVE-2025-4404).

* Tue Jan 28 2025 Stanislav Levin <slev@altlinux.org> 4.9.14-alt3.p10.1
- Backported fix for https://pagure.io/freeipa/issue/9734.

* Fri Jan 17 2025 Stanislav Levin <slev@altlinux.org> 4.9.14-alt2.p10.1
- Backported upstream fixes (fixes: CVE-2024-11029).

* Fri Aug 23 2024 Stanislav Levin <slev@altlinux.org> 4.9.14-alt0.p10.3
- Backported upstream fixes:
  + synced to 81f61f81e72da0dc91be51857937ab1412e05299
  + (fixes: CVE-2024-1481)

* Mon Jun 10 2024 Stanislav Levin <slev@altlinux.org> 4.9.14-alt0.p10.2
- Backported CVE fixes (fixes: CVE-2024-3183, CVE-2024-2698).

* Wed Jan 10 2024 Stanislav Levin <slev@altlinux.org> 4.9.14-alt0.p10.1
- Backported 4.9.14.

* Fri Feb 17 2023 Stanislav Levin <slev@altlinux.org> 4.9.11-alt0.p10.1
- Backported 4.9.11.
